    ...
    public partial class Product : System.Web.UI.Page
    {
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                ctrlProduct.productid = productId.ToString();
                


                ctrlProduct.purchprice = Convert.ToDecimal(row.Cells[3].Text);
                ctrlProduct.saleprice = Convert.ToDecimal(row.Cells[2].Text);
                ctrlProduct.productname = row.Cells[0].Text;
                ctrlProduct.productcode = row.Cells[4].Text;
                ctrlProduct.HSNcode = row.Cells[10].Text;
                ctrlProduct.reorderlevel = Convert.ToInt32(row.Cells[5].Text);
                //int taxId = GridView1.SelectedIndex;
                ctrlProduct.categoryid = Convert.ToInt32(row.Cells[6].Text);
                ctrlProduct.unitid = Convert.ToInt32(row.Cells[9].Text);
                ctrlProduct.godownid = Convert.ToInt32(row.Cells[7].Text);
                ctrlProduct.rackid = Convert.ToInt32(row.Cells[8].Text);
